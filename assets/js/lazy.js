window.onload = () => {
  ...
  images.forEach(element => {
    ...
    largeImage.onload = function () {
      ...
      element.sizes = element.hasAttribute("data-sizes") ? element.getAttribute("data-sizes") : "";
      element.srcset = element.hasAttribute("data-srcset") ? element.getAttribute("data-srcset") : "";
